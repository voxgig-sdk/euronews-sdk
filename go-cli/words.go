...
func registerSDKWords(r *eng.Registry, client *sdk.EuronewsSDK) {
...
func runOp(client *sdk.EuronewsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
