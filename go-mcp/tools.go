...
func registerTools(server *mcp.Server, client *sdk.EuronewsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "euronews_list",
		Description: "List records from Euronews. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "euronews_load",
		Description: "Load a single record from Euronews. " +
...
func runOp(client *sdk.EuronewsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EuronewsSDK, name string) (sdk.EuronewsEntity, error) {
