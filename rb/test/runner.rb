...
module EuronewsTestRunner
  ...
  def self.env_override(m)
    live = getenv("EURONEWS_TEST_LIVE")
    override = getenv("EURONEWS_TEST_OVERRIDE")
    ...
    explain = getenv("EURONEWS_TEST_EXPLAIN")
    m["EURONEWS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = EuronewsTestRunner
Helpers = EuronewsHelpers
Vs = VoxgigStruct
