...
function liveScenariosActive() { return false && process.env.EURONEWS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'EURONEWS_TEST_NEW_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.EuronewsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['EURONEWS_TEST_NEW_ENTID'];
    ...
    const client = new __1.EuronewsSDK({
        base: 'http://localhost:8080',
