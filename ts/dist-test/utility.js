...
function envOverride(m) {
    if ('TRUE' === process.env.EURONEWS_TEST_LIVE ||
        'TRUE' === process.env.EURONEWS_TEST_OVERRIDE) {
    ...
    m.EURONEWS_TEST_EXPLAIN = process.env.EURONEWS_TEST_EXPLAIN || m.EURONEWS_TEST_EXPLAIN;
    return m;
}
