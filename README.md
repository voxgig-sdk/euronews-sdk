...
Euronews API client, generated from the OpenAPI spec.

This API provides access to the latest breaking news from ru.euronews.com, allowing users to stay informed about European and world news across various topics including economy, politics, and diplomacy.

Learn more about Euronews API at [github.com/l0v3m0n3y/euronews](https://github.com/l0v3m0n3y/euronews).

This is an unofficial SDK for the Euronews public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
```bash
cd go-mcp && go build -o euronews-mcp .
```
...
```json
{
  "mcpServers": {
    "euronews": {
      "command": "/abs/path/to/euronews-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **New** | The New entity (list). | `/breaking-news.json` |
...
```go
import sdk "github.com/voxgig-sdk/euronews-sdk/go"
...
- Upstream API: [https://github.com/l0v3m0n3y/euronews](https://github.com/l0v3m0n3y/euronews)
...
Generated from the Euronews API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
