...
class EuronewsTestRunner
{
    ...
    {
        $live = self::getenv('EURONEWS_TEST_LIVE');
        $override = self::getenv('EURONEWS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('EURONEWS_TEST_EXPLAIN');
...
class_alias('EuronewsTestRunner', 'Runner');
class_alias('EuronewsHelpers', 'Helpers');
