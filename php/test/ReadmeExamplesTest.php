...
// Euronews SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EuronewsSDK::test)
...
{
    private const SDK_CLASS = 'EuronewsSDK';
    ...
    private const SDK_BASE = 'euronews_sdk';
