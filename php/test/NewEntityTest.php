...
class NewEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = EuronewsSDK::test($seed, null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EURONEWS_TEST_NEW_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function new_basic_setup($extra)
{
    ...
    $client = EuronewsSDK::test($options, $extra);
    ...
    $entid_env_raw = getenv("EURONEWS_TEST_NEW_ENTID");
    ...
    if ($env["EURONEWS_TEST_LIVE"] === "TRUE") {
        ...
        $client = new EuronewsSDK(Helpers::to_map($merged_opts));
    }
