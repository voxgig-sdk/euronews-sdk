...
// Euronews SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class EuronewsTestFeature extends EuronewsBaseFeature
{
    ...
    public function init(EuronewsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (EuronewsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (EuronewsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(EuronewsContext $ctx, $op, $args): array
    {
