...
class EuronewsProxyFeature extends EuronewsBaseFeature
{
    ...
    public function init(EuronewsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EuronewsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
