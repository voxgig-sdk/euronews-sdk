...
class EuronewsTimeoutFeature extends EuronewsBaseFeature
{
    ...
    private function _with_timeout(EuronewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EuronewsContext $_ctx, float $ms): void
    {
        $client = $this->client;
