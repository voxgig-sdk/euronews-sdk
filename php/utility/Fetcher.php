...
// Euronews SDK utility: fetcher

class EuronewsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EuronewsSDK/1.0)';
    ...
    public static function call(EuronewsContext $ctx, string $fullurl, array $fetchdef): array
    {
