...
Results: Successfully retrieved breaking news.

SDK operations: `list`.

Key fields to recognise:

- `category`: Category of the news (for example, economy, politics, diplomacy)
...
| --- | --- | --- | --- |
| New | `list` | `GET /breaking-news.json` | See reference |

## Connect to the API

- Euronews API Server: `https://ru.euronews.com/api`
...
- `euronews_list`: List records for an entity. Supported entities: `new`.
- `euronews_load`: Load one record for an entity. No active entity supports this operation.
