...
from euronews_sdk.utility import register

# Load features
from euronews_sdk.feature.base_feature import EuronewsBaseFeature
from euronews_sdk.features import _has_feature, _make_feature
...
class EuronewsSDK:
    ...
    def get_utility(self):
        return EuronewsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EuronewsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def New(self, data=None) -> "NewEntity":
        ...
        from euronews_sdk.entity.new_entity import NewEntity
        return NewEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "EuronewsSDK":
        if sdkopts is None:
            sdkopts = {}
