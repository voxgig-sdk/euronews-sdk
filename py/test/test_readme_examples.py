# Euronews SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EuronewsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EuronewsSDK(...) and EuronewsSDK.test(...) become
#      EuronewsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "euronews_sdk"
_SDK_CLASS = "EuronewsSDK"
