...
|---|---|---|
| `ts/` | @voxgig-sdk/euronews-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/euronews-sdk \
      --repository voxgig-sdk/euronews-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/euronews-sdk` shows it, and
`npm trust revoke @voxgig-sdk/euronews-sdk --id=<id>` removes it.
