...
from projectname_sdk import EuronewsSDK
from projectname_sdk.core.spec import EuronewsSpec
from projectname_sdk.core.result import EuronewsResult
from projectname_sdk.core.response import EuronewsResponse
from projectname_sdk.core.operation import EuronewsOperation
from projectname_sdk.core.error import EuronewsError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import EuronewsBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = EuronewsSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = EuronewsSDK.test(None, None)
        ...
        class TestInitFeature(EuronewsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(EuronewsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = EuronewsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = EuronewsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = EuronewsSDK.test(None, setup_opts)
