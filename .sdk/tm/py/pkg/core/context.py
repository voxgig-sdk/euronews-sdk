...
from projectname_sdk.core.control import EuronewsControl
...
class EuronewsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, EuronewsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EuronewsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return EuronewsError(code, msg, self)
