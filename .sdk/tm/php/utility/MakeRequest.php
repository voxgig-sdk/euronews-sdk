...
// Euronews SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EuronewsMakeRequest
{
    public static function call(EuronewsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EuronewsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EuronewsResponse($fetched);
        } else {
