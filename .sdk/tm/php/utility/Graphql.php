...
class EuronewsGraphql
{
    ...
    // equivalent.
    public static function body(EuronewsContext $ctx): mixed
    {
    ...
    public static function errors(EuronewsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
