...
// Euronews SDK clienttrack feature
...
class EuronewsClienttrackFeature extends EuronewsBaseFeature
{
    ...
    public function PostConstruct(EuronewsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Euronews-SDK';
