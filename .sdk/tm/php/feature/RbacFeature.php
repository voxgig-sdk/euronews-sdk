...
class EuronewsRbacFeature extends EuronewsBaseFeature
{
    ...
    private function _required(EuronewsContext $ctx): ?string
    {
    ...
    private function _reject(EuronewsContext $ctx, string $required): void
    {
    ...
    private function _track(EuronewsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
