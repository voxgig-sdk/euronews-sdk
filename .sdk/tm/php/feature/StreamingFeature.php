...
// Euronews SDK streaming feature
...
class EuronewsStreamingFeature extends EuronewsBaseFeature
{
    ...
    private function _iterate(EuronewsResult $result): \Generator
    {
    ...
    private function _streamable(EuronewsContext $ctx): bool
    {
