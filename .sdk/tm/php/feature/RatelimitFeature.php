...
// Euronews SDK ratelimit feature
...
class EuronewsRatelimitFeature extends EuronewsBaseFeature
{
    ...
    private function _acquire(EuronewsContext $ctx): void
    {
    ...
    private function _track(EuronewsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
