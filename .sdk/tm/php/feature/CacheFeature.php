...
class EuronewsCacheFeature extends EuronewsBaseFeature
{
    ...
    private function _through(EuronewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
