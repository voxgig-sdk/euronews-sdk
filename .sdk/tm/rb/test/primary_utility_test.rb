...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = EuronewsOmni.make_runner(TEST_JSON_FILE, EuronewsSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : EuronewsOmni.errify(err)
    end
